...
import { Search, MapPin, Download, ChevronRight, Lightbulb } from "lucide-react";
          ...
          <div className="p-6 border-b border-border">
            ...
            <div className="space-y-3">
              ...
              <SsInput
                ...
                placeholder="Specific business idea (optional)"
                value={businessType}
                ...
                <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                  <div>
                    ...
                    <p className="mt-1 font-mono text-xs text-text-muted">
                      📍 {scan.location} {scan.businessType && ` · 💡 ${scan.businessType}`} · Scanned just now
                    </p>
                  </div>
